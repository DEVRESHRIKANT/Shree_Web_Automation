h<%@ Page Title="" Language="C#" MasterPageFile="~/Shree.Master" AutoEventWireup="true" CodeBehind="Deals.aspx.cs" Inherits="MotelMa.Deals" %>
    ...
    <asp:Content ID="MiddleBar" ContentPlaceHolderID="MiddleBar"  runat="server">
        ...
        <table style="width:100%; padding:0px 0px 0px 0px">
            <tr>
                ...
                <td>
                    <div>
                        <b>AARP / AAA / Military / Seniors Saving More</b>
                    </div>
                </td>                                            
            </tr>
            <tr>
                <td colspan="2">
                    <div>
                        <p>
                        Green Valley Motel is proud to offer members a 10% discount* off our standard rates, as well as free Wi-Fi and late checkout until 2 p.m.† upon request. This special AARP member discount* is available at each of our 1,300+ locations, so you can save more for what you travel for. 
                        </p>
                        <p>
                        <b>Online Booking:</b> When you arrive at the reservation page, select “Offer” in the drop-down menu to receive your discount.*
                        </p>
                         <p>                          
                        <b>Call to Book:</b> Call 609-225-7855 and mention your interest in receiving the AARP discount.*
                        </p>
                        <p>
