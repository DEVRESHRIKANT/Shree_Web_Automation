<%@ Page Title="" Language="C#" MasterPageFile="~/Shree.Master" AutoEventWireup="true" CodeBehind="AARP.aspx.cs" Inherits="MotelMa.AARP" %>
...
<%--Mission and About Us Contents Start Here--%>
        ...
        <table style="width:100%; padding:0px 0px 0px 0px">
            <tr>
                <td style="height:50px; width:10%">
                    <asp:Image ID="corporate" BorderColor="YellowGreen" runat="server" ImageUrl="~/Images/AARP.jpg" />
                </td>
                <td>
                    <div>
    ...
    <div class="renoCards">
        <div class="parsys genericRightColumn">
            <div class="contentCardV2 section">
            <div class="media cardContainer card1">
                <div class="cardWrap">
                    <a href='http://www.MotelMA.com/aarp.aspx' target="_self">
                        <div class="contentCard2" style="background-image: url('/Images/Banner1.jpg');">
                            <h2 class="contentCardTitle2 black">Renovated Rooms</h2>
                                <span class="contentCardCTAtext bold">SEE MORE INFO</span><i class="icon icon-internalLink"></i>
                        </div>
                    </a>
                </div>
            </div>
