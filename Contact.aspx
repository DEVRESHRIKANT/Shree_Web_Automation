<%@ Page Title="" Language="C#" MasterPageFile="~/Shree.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="MotelMa.Contact" %>
...
<asp:Content ID="Content10" ContentPlaceHolderID="LeftBar" runat="server">
    <ShreeMain:ShreeLeft runat="server" id="LeftBar"/>
                <div id="divResult" runat="server"></div>
	            <div id="divError" runat="server"></div>
   <%-- <% Html.RenderPartial((string) ViewBag._ViewName); %>--%>
</asp:Content>
<asp:Content ID="Content11" ContentPlaceHolderID="MiddleBar" runat="server">
    <div>
...
<asp:Content ID="Content12" ContentPlaceHolderID="RightBar" runat="server">
        <ShreeMain:ShreeRight runat="server" id="RightBar"/>
</asp:Content>
<asp:Content ID="Content13" ContentPlaceHolderID="BottomBar" runat="server">
